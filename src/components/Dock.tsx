...
import { Award, Home, Globe, Blocks, Users2, QrCode, type LucideIcon } from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-3 rounded-xl text-xs font-semibold whitespace-nowrap text-zinc-400 hover:text-white transition-colors mt-1 pt-4 border-t border-white/10 cursor-pointer"
        >
          <QrCode className="w-4 h-4 flex-shrink-0 text-zinc-400" />
